...
# Что я сделал в этом форке:
 - Переделан код исключительно под Xtensa (ESP32), был AVR. Из-за оригинального предназначения для AVR, были несовместимости с Xtensa.
 ...
 - Сделан `WatchDog`. который останавливает моторы, если никакой команды не было принято и распознано, а также раскомментирована константа `USE_WATCH_DOG`.
